...
1. Первая аксиома выполняется автоматически. Вторая аксиома доказывается методом пристального взгляда. А вот третью аксиому уже нужно доказывать. Так почти всегда, первые 2 аксиомы доказываются лекго, а третья в основном не очевидно. 
\end{solution}
